...
namespace Minio.Functional.Tests
{
    public static class FunctionalTest
    {
        ...
        internal static async Task TearDown(MinioClient minio, string bucketName)
        {
                    ...
                    StringComparison.OrdinalIgnoreCase) == true)
            {
                foreach (var item in objectNamesVersions)
                {
                    ...
                    var retentionConfig =
                        await minio.GetObjectRetentionAsync(objectRetentionArgs).ConfigureAwait(false);
        ...
        internal static async Task PutGetStatEncryptedObject_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("PutGetStatEncryptedObject_Test1", putObjectSignature,
                    "Tests whether Put/Get/Stat Object with encryption passes", TestStatus.PASS,
            ...
            {
                new MintLogger("PutGetStatEncryptedObject_Test1", putObjectSignature,
                    "Tests whether Put/Get/Stat Object with encryption passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    "", ex.Message, ex.ToString(), args).Log();
                throw;
            }
        ...
        internal static async Task StatObject_Test1(MinioClient minio)
        {
            ...
            {
                new MintLogger(nameof(StatObject_Test1), statObjectSignature,
        ...
        internal static async Task FPutObject_Test2(MinioClient minio)
        {
            ...
            try
            {
                ...
                var putObjectArgs = new PutObjectArgs()
                    ...
                    .WithFileName(fileName);
                await minio.PutObjectAsync(putObjectArgs).ConfigureAwait(false);
                new MintLogger("FPutObject_Test2", putObjectSignature,
        ...
        internal static async Task RemoveObject_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("RemoveObject_Test1", removeObjectSignature1,
                    "Tests whether RemoveObjectAsync for existing object passes", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (Exception ex)
            {
                new MintLogger("RemoveObject_Test1", removeObjectSignature1,
                    "Tests whether RemoveObjectAsync for existing object passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    ex.Message, ex.ToString(), args: args).Log();
                throw;
            }
 ...
 = md5CSV.ComputeHash(Encoding.UTF8.GetBytes(csvStringNoWS));
        ...
        internal static async Task BucketEncryptionsAsync_Test1(MinioClient minio)
        {
            ...
            catch (Exception ex)
            {
                ...
                new MintLogger(nameof(BucketEncryptionsAsync_Test1), setBucketEncryptionSignature,
                    "Tests whether SetBucketEncryptionAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            {
                new MintLogger(nameof(BucketEncryptionsAsync_Test1), setBucketEncryptionSignature,
                    "Tests whether SetBucketEncryptionAsync passes", TestStatus.NA, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
            }
            catch (Exception ex)
            ...
            {
                new MintLogger(nameof(BucketEncryptionsAsync_Test1), getBucketEncryptionSignature,
                    "Tests whether GetBucketEncryptionAsync passes", TestStatus.NA, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
            }
            catch (Exception ex)
            {
                await TearDown(minio, bucketName).ConfigureAwait(false);
                new MintLogger(nameof(BucketEncryptionsAsync_Test1), getBucketEncryptionSignature,
                    "Tests whether GetBucketEncryptionAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            catch (NotImplementedException ex)
            {
                new MintLogger(nameof(BucketEncryptionsAsync_Test1), removeBucketEncryptionSignature,
                    "Tests whether RemoveBucketEncryptionAsync passes", TestStatus.NA, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
            }
            catch (Exception ex)
        ...
        internal static async Task LegalHoldStatusAsync_Test1(MinioClient minio)
        {
            ...
            catch (Exception ex)
            {
                await TearDown(minio, bucketName).ConfigureAwait(false);
                new MintLogger(nameof(LegalHoldStatusAsync_Test1), setObjectLegalHoldSignature,
                    "Tests whether SetObjectLegalHoldAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            {
                new MintLogger(nameof(LegalHoldStatusAsync_Test1), getObjectLegalHoldSignature,
                    "Tests whether GetObjectLegalHoldAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
        ...
        internal static async Task BucketTagsAsync_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger(nameof(BucketTagsAsync_Test1), setBucketTagsSignature,
                        "Tests whether SetBucketTagsAsync passes", TestStatus.PASS, DateTime.Now - startTime,
                        args: args)
                    .Log();
            }
            catch (NotImplementedException ex)
            ...
            try
            {
                ...
                new MintLogger(nameof(BucketTagsAsync_Test1), getBucketTagsSignature,
                        "Tests whether GetBucketTagsAsync passes", TestStatus.PASS, DateTime.Now - startTime,
                        args: args)
                    .Log();
            }
            catch (NotImplementedException ex)
            ...
            catch (Exception ex)
            {
                ...
                {
                    new MintLogger(nameof(BucketTagsAsync_Test1), deleteBucketTagsSignature,
                        "Tests whether RemoveBucketTagsAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString(), args: args).Log();
                    throw;
                }
            ...
            foreach (var size in sizesList)
            {
                ...
                catch (Exception ex)
                {
                    new MintLogger(nameof(ObjectTagsAsync_Test1), setObjectTagsSignature,
                        "Tests whether SetObjectTagsAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString(), args: args).Log();
                    throw;
                }
                ...
                catch (Exception ex)
                {
                    exceptionThrown = true;
                    new MintLogger(nameof(ObjectTagsAsync_Test1), getObjectTagsSignature,
                        "Tests whether GetObjectTagsAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString(), args: args).Log();
                    throw;
                }
                ...
                {
                    new MintLogger(nameof(ObjectTagsAsync_Test1), deleteObjectTagsSignature,
                        "Tests whether RemoveObjectTagsAsync passes", TestStatus.NA, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString(), args: args).Log();
                }
                catch (Exception ex)
                {
                    new MintLogger(nameof(ObjectTagsAsync_Test1), deleteObjectTagsSignature,
                        "Tests whether RemoveObjectTagsAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString(), args: args).Log();
                    throw;
                }
        ...
        internal static async Task ObjectLockConfigurationAsync_Test1(MinioClient minio)
        {
            ...
            try
            {
                if (setLockNotImplemented || getLockNotImplemented)
                {
                    ...
                    new MintLogger(nameof(ObjectLockConfigurationAsync_Test1), deleteObjectLockConfigurationSignature,
                        "Tests whether RemoveObjectLockConfigurationAsync passes", TestStatus.NA,
                        DateTime.Now - startTime,
                ...
                new MintLogger(nameof(ObjectLockConfigurationAsync_Test1), deleteObjectLockConfigurationSignature,
                    "Tests whether RemoveObjectLockConfigurationAsync passes", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (NotImplementedException ex)
            ...
            {
                new MintLogger(nameof(ObjectLockConfigurationAsync_Test1), deleteObjectLockConfigurationSignature,
                    "Tests whether RemoveObjectLockConfigurationAsync passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    ex.Message, ex.ToString(), args: args).Log();
                throw;
            }
        ...
        internal static async Task ObjectRetentionAsync_Test1(MinioClient minio)
        {
            ...
            catch (Exception ex)
            {
                await TearDown(minio, bucketName).ConfigureAwait(false);
                new MintLogger(nameof(ObjectRetentionAsync_Test1), setObjectRetentionSignature,
                    "Tests whether SetObjectRetentionAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            catch (Exception ex)
            {
                await TearDown(minio, bucketName).ConfigureAwait(false);
                new MintLogger(nameof(ObjectRetentionAsync_Test1), getObjectRetentionSignature,
                    "Tests whether GetObjectRetentionAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            catch (NotImplementedException ex)
            {
                new MintLogger(nameof(ObjectRetentionAsync_Test1), clearObjectRetentionSignature,
                    "Tests whether ClearObjectRetentionAsync passes", TestStatus.NA, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
            }
            catch (Exception ex)
            ...
            {
                new MintLogger(nameof(ObjectRetentionAsync_Test1), clearObjectRetentionSignature,
                    "TearDown operation ClearObjectRetentionAsync", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
        ...
        internal static async Task MakeBucket_Test3(MinioClient minio, bool aws = false)
        {
            ...
            try
            {
                ...
                var found = await minio.BucketExistsAsync(beArgs).ConfigureAwait(false);
                Assert.IsTrue(found);
                new MintLogger(nameof(MakeBucket_Test3), makeBucketSignature,
        ...
        internal static async Task MakeBucketLock_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                var found = await minio.BucketExistsAsync(beArgs).ConfigureAwait(false);
                Assert.IsTrue(found);
                new MintLogger(nameof(MakeBucket_Test1), makeBucketSignature,
        ...
        internal static async Task PutObject_Test3(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger(nameof(PutObject_Test3), putObjectSignature,
                    "Tests whether PutObject with custom content-type passes", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (Exception ex)
            {
                new MintLogger(nameof(PutObject_Test3), putObjectSignature,
                    "Tests whether PutObject with custom content-type passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    "", ex.Message, ex.ToString(), args).Log();
                throw;
            }
        ...
        internal static async Task PutObject_Test7(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger(nameof(PutObject_Test7), putObjectSignature,
                    "Tests whether PutObject with unknown stream-size passes", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (Exception ex)
            {
                new MintLogger(nameof(PutObject_Test7), putObjectSignature,
                    "Tests whether PutObject with unknown stream-size passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    "", ex.Message, ex.ToString(), args).Log();
                throw;
            }
        ...
        internal static async Task CopyObject_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("CopyObject_Test1", copyObjectSignature, "Tests whether CopyObject passes",
                    TestStatus.PASS,
                    DateTime.Now - startTime, args: args).Log();
            }
            catch (Exception ex)
        ...
        internal static async Task CopyObject_Test3(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("CopyObject_Test3", copyObjectSignature,
        ...
        internal static async Task CopyObject_Test4(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("CopyObject_Test4", copyObjectSignature,
                    "Tests whether CopyObject defaults targetName to objectName", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (Exception ex)
            {
                new MintLogger("CopyObject_Test4", copyObjectSignature,
                    "Tests whether CopyObject defaults targetName to objectName", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    ex.Message, ex.ToString(), args: args).Log();
                throw;
            }
        ...
        internal static async Task CopyObject_Test8(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("CopyObject_Test8", copyObjectSignature,
                    "Tests whether CopyObject with metadata replacement passes", TestStatus.PASS,
                    DateTime.Now - startTime,
                    args: args).Log();
            }
            catch (Exception ex)
            {
                new MintLogger("CopyObject_Test8", copyObjectSignature,
                    "Tests whether CopyObject with metadata replacement passes", TestStatus.FAIL,
                    DateTime.Now - startTime,
                    ex.Message, ex.ToString(), args: args).Log();
                throw;
            }
        ...
        internal static async Task CopyObject_Test9(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("CopyObject_Test9", copyObjectSignature, "Tests whether CopyObject passes",
                    TestStatus.PASS,
                    DateTime.Now - startTime, args: args).Log();
            }
            catch (Exception ex)
        ...
        internal static async Task EncryptedCopyObject_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("EncryptedCopyObject_Test1", copyObjectSignature,
                        "Tests whether encrypted CopyObject passes", TestStatus.PASS, DateTime.Now - startTime,
                        args: args)
                    .Log();
            }
            catch (NotImplementedException ex)
        ...
        internal static async Task FGetObject_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                var getObjectArgs = new GetObjectArgs()
                    ...
                    .WithFile(outFileName);
                await minio.GetObjectAsync(getObjectArgs).ConfigureAwait(false);
                new MintLogger("FGetObject_Test1", getObjectSignature,
            ...
            try
            {
                ...
                catch (Exception ex)
                {
                    new MintLogger("ListIncompleteUpload_Test1", listIncompleteUploadsSignature,
                        "Tests whether ListIncompleteUpload passes", TestStatus.FAIL, DateTime.Now - startTime,
                        ex.Message,
                        ex.ToString()).Log();
                    return;
                }
        ...
        internal static async Task SetBucketPolicy_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("SetBucketPolicy_Test1", setBucketPolicySignature,
        ...
        internal static async Task GetBucketPolicy_Test1(MinioClient minio)
        {
            ...
            try
            {
                ...
                new MintLogger("GetBucketPolicy_Test1", getBucketPolicySignature,
        ...
        internal static async Task BucketLifecycleAsync_Test1(MinioClient minio)
        {
            ...
            catch (Exception ex)
            {
                ...
                new MintLogger(nameof(BucketLifecycleAsync_Test1), setBucketLifecycleSignature,
                    "Tests whether SetBucketLifecycleAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            catch (Exception ex)
            {
                await TearDown(minio, bucketName).ConfigureAwait(false);
                new MintLogger(nameof(BucketLifecycleAsync_Test1) + ".2", getBucketLifecycleSignature,
                    "Tests whether GetBucketLifecycleAsync passes", TestStatus.FAIL, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
                throw;
            }
            ...
            catch (NotImplementedException ex)
            {
                new MintLogger(nameof(BucketLifecycleAsync_Test1) + ".3", deleteBucketLifecycleSignature,
                    "Tests whether RemoveBucketLifecycleAsync passes", TestStatus.NA, DateTime.Now - startTime,
                    ex.Message,
                    ex.ToString(), args: args).Log();
            }
            catch (Exception ex)
