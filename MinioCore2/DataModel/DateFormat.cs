...
namespace MinioCore2.DataModel
{
    ...
    */
    ...
    {
  /*
         public static const DateTimeFormatter AMZ_DATE_FORMAT =
      DateTimeFormat.forPattern("yyyyMMdd'T'HHmmss'Z'").withZoneUTC().withLocale(Locale.US);

            public static const DateTimeFormatter EXPIRATION_DATE_FORMAT =
      DateTimeFormat.forPattern("yyyy-MM-dd'T'HH':'mm':'ss'.'SSS'Z'").withZoneUTC().withLocale(Locale.US);

            public static const DateTimeFormatter RESPONSE_DATE_FORMAT = EXPIRATION_DATE_FORMAT;

  public static const DateTimeFormatter SIGNER_DATE_FORMAT =
      DateTimeFormat.forPattern("yyyyMMdd").withZoneUTC().withLocale(Locale.US);

            public static const DateTimeFormatter HTTP_HEADER_DATE_FORMAT =
