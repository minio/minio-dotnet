...
public class RetryTests : MinioUnitTests
{
    ...
    [
        ...
        [HttpStatusCode.Locked /* 423 */, false ],
        ...
        [HttpStatusCode.NotImplemented /* 501 */, true ],
        [HttpStatusCode.BadGateway /* 502 */, true ],
        [HttpStatusCode.ServiceUnavailable /* 503 */, true ],
        [HttpStatusCode.GatewayTimeout /* 504 */, true ],
        [HttpStatusCode.HttpVersionNotSupported /* 505 */, true ],
        [HttpStatusCode.VariantAlsoNegotiates /* 506 */, true ],
        [HttpStatusCode.InsufficientStorage /* 507 */, true ],
        [HttpStatusCode.LoopDetected /* 508 */, true ],
        [HttpStatusCode.NotExtended /* 510 */, true ],
        [HttpStatusCode.NetworkAuthenticationRequired /* 511 */, true],
    ];
