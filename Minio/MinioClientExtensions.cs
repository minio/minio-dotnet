...
namespace Minio
{
    public static class MinioClientExtensions
    {
        ...
        public static MinioClient Build(this MinioClient minioClient)
        {
            ...
            minioClient.HttpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent",
        ...
        internal static Uri GetBaseUrl(string endpoint)
        {
            ...
            {
                throw new InvalidEndpointException(
                    string.Format(CultureInfo.InvariantCulture, "{0}, {1} is invalid hostname.", endpoint,
                        hostnameOfUri),
                    "endpoint");
            }
