...
namespace Minio.DataModel
{
    ...
    public class PostPolicy
    {
        ...
        public void SetContentLength(long contentLength)
        {
            ...
            this.policies.Add(new Tuple<string, string, string>("content-length-range", contentLength.ToString(),
        ...
        public void SetContentRange(long startRange, long endRange)
        {
            ...
            this.policies.Add(new Tuple<string, string, string>("content-length-range", startRange.ToString(),
                endRange.ToString()));
        }
        ...
        private byte[] MarshalJson()
        {
            ...
            sb.Append("{");
            sb.Append("\"expiration\":\"").Append(this.expiration.ToString("yyyy-MM-ddTHH:mm:ss.000Z")).Append("\"")
                .Append(",");
        ...
        {
            var policyStrBytes = this.MarshalJson();
