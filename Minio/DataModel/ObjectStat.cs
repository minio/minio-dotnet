    ...
    public class ObjectStat
    {
        ...
        public override string ToString()
        {
            ...
            if (!string.IsNullOrWhiteSpace(VersionId))
            {
                ...
                if (DeleteMarker)
                {
                    versionInfo = $"Version ID({VersionId}, deleted)";
                }
            }

            if (Expires is not null)
            {
                expires = "Expiry(" + Utils.To8601String(Expires.Value) + ")";
            }
            ...
            if (TaggingCount is not null)
            {
                taggingCount = "Tagging-Count(" + TaggingCount.Value + ")";
            }
            ...
            {
                archiveStatus = "Archive Status(" + ArchiveStatus + ")";
            }
