...
[Serializable]
public class InvalidExpiryRangeException : NewteraException
{
    ...
    protected InvalidExpiryRangeException(SerializationInfo serializationInfo, StreamingContext streamingContext) :
