    ...
    where T : AssumeRoleBaseProvider<T>
{
    ...
    protected AssumeRoleBaseProvider(INewteraClient client)
    {
        Client = client;
    }
    ...
    internal INewteraClient Client { get; set; }
    ...
    {
        if (Client is null) throw new InvalidOperationException("NewteraClient is not set in AssumeRoleBaseProvider");
