...
public static class LoggingExtensions
{
    ...
    internal static void LogRequest(this INewteraClient newteraClient, HttpRequestMessage request, ResponseResult response,
        double durationMs)
    {
        ...
        newteraClient.RequestLogger.LogRequest(requestToLog, responseToLog, durationMs);
    }
}
