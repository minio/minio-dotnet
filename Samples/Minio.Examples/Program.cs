...
namespace Minio.Examples
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (enableHTTPS)
                minioClient = MinioClient.Create(endPoint, accessKey, secretKey).WithSsl();
            else
                minioClient = MinioClient.Create(endPoint, accessKey, secretKey);
            ...
            try
            {
                ...
                // Set app Info 
                minioClient.SetCustomUserAgent("app-name app-version");
                ...
                Cases.ListObjects.Run(minioClient, bucketName).Wait();
                ...
                Cases.ListIncompleteUploads.Run(minioClient, bucketName).Wait();
                ...
                Cases.SetBucketPolicy.Run(minioClient, PolicyType.ReadOnly, bucketName).Wait();
