...
namespace Minio.Tests
{
    ...
    [TestFixture]
    internal class StatObjectTests : AbstractMinioTests
    {
        /// <summary>
        ...
        public async Task HappyCase()
        {
            ...
            // assert
            Assert.NotNull(statObject);
            Assert.NotNull(statObject.ObjectName);
            Assert.NotNull(statObject.Size);

            // log
            Console.Out.WriteLine("Details of the object " + fileName + " are " + statObject);
        }
    }
}